...
The landing also includes `policy-cases.json`: synthetic allowed, denied and approval-pending results from the 0.6.0 GitHub example executed against a fake peer. These policy records are not signed destination receipts. Regeneration instructions are in `landing/README.md`.
